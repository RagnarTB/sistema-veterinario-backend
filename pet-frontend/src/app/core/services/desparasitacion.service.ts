...
export class DesparasitacionService {
  ...
  actualizarProximaDosis(id: number, fecha: string): Observable<DesparasitacionResponse> {
    return this.http.put<DesparasitacionResponse>(`${this.apiUrl}/${id}/proxima-dosis`, { fecha });
  }
