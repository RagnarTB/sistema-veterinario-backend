...
public class AtencionMedicaController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('CREAR_REGISTROS_CLINICOS')") // candado para abrir el metodo segun el rol
    ...
    public ResponseEntity<Page<AtencionMedicaResponseDTO>> listarPorPaciente(
            @PathVariable Long pacienteId, Pageable pageable) {
        Page<AtencionMedicaResponseDTO> atenciones = atencionMedicaServicio.listarPorPaciente(pacienteId, pageable);
        return ResponseEntity.ok(atenciones);
    }
}