...
public class RolController {
    ...
    public RolResponseDTO actualizarPermisos(@PathVariable Long id, @RequestBody List<String> permisosNombres) {
        return rolServicio.actualizarPermisos(id, permisosNombres);
    }
}
