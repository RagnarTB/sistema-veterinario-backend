...
public class CitaServicio {
        ...
        public CitaResponseDTO guardar(CitaRequestDTO dto) {
                ...
                if (usuarioAutenticadoService.esCliente()) {
                        ...
                        if (!clienteBase.getId().equals(clienteActualId)) {
                                throw new BusinessLogicException("No puedes agendar citas para mascotas que no te pertenecen.");
                        }
                }
        ...
        public Page<CitaResponseDTO> listar(Long sedeId, String buscar, Pageable pageable) {
                ...
                if (usuarioAutenticadoService.esCliente()) {
                        ...
                        if (buscar != null && !buscar.trim().isEmpty()) {
                                pagina = citaRepositorio.buscarEnSedePorCliente(sedeId, clienteId, buscar, pageable);
                        } else {
                                pagina = citaRepositorio.findBySedeIdAndClienteId(sedeId, clienteId, pageable);
                        }
                } else {
                        if (buscar != null && !buscar.trim().isEmpty()) {
        ...
        public Page<CitaResponseDTO> listarConFiltros(Long sedeId, LocalDate fecha, EstadoCita estado,
                ...
                if (usuarioAutenticadoService.esCliente()) {
                        ...
                        if (fecha != null && veterinarioId != null && estado != null) {
                                pagina = citaRepositorio.findBySedeIdAndFechaAndVeterinarioIdAndEstadoAndClienteId(sedeId, fecha, veterinarioId, estado, clienteId, pageable);
                        } else if (fecha != null && veterinarioId != null) {
                                pagina = citaRepositorio.findBySedeIdAndFechaAndVeterinarioIdAndClienteId(sedeId, fecha, veterinarioId, clienteId, pageable);
                        } else if (fecha != null && estado != null) {
                                pagina = citaRepositorio.findBySedeIdAndFechaAndEstadoAndClienteId(sedeId, fecha, estado, clienteId, pageable);
                        } else if (fecha != null) {
                                pagina = citaRepositorio.findBySedeIdAndFechaAndClienteId(sedeId, fecha, clienteId, pageable);
        ...
        public CitaResponseDTO buscarPorId(Long id) {
                ...
                if (usuarioAutenticadoService.esCliente()) {
                        ...
                        if (citaDb.getPacientes() != null && !citaDb.getPacientes().isEmpty()) {
                                clienteCita = citaDb.getPacientes().get(0).getCliente();
                        }
                        if (clienteCita == null || !clienteCita.getId().equals(clienteActualId)) {
                                throw new BusinessLogicException("No tienes permiso para ver esta cita.");
                        }
                }

                return mapearAResponse(citaDb);
        }
        ...
        public CitaResponseDTO actualizar(Long id, CitaRequestDTO dto) {
                ...
                if (usuarioAutenticadoService.esCliente()) {
                        Long clienteActualId = usuarioAutenticadoService.obtenerClienteActual().getId();
                        if (!clienteBase.getId().equals(clienteActualId)) {
                                throw new BusinessLogicException("No puedes reprogramar citas para mascotas que no te pertenecen.");
                        }
                }
        ...
        public void eliminar(Long id) {
                ...
                if (usuarioAutenticadoService.esCliente()) {
                        ...
                        if (clienteCita == null || !clienteCita.getId().equals(clienteActualId)) {
                                throw new BusinessLogicException("No puedes cancelar citas para mascotas que no te pertenecen.");
                        }
                }
        ...
        private CitaResponseDTO mapearAResponse(Cita cita) {
                ...
                if (cita.getVeterinario() != null && cita.getVeterinario().getUsuario() != null) {
                        ...
                        veterinarioEmail = cita.getVeterinario().getUsuario().getEmail();
                }
